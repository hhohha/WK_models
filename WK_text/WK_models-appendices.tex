...
\begin{figure*}[h]\centering
  \centering
  \includegraphics[width=\linewidth,height=1.7in]{placeholder.pdf}\\[1pt]
  \includegraphics[width=0.24\linewidth]{placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{placeholder.pdf}
...
\begin{figure}[hbt]
	\centering
	\includegraphics[width=0.3\textwidth]{keep-calm.png}
