...
\begin{itemize}
  ...
  \item{Set of test scripts that run the various tests comparing heurisctics, performance etc.}
...
\begin{itemize}
  \item{\textit{nts}: set of non-terminals, which are represented by alpha-numeric characters}
  \item{\textit{ts}: set of terminals, also represented by alpha-numeric characters}
  \item{\textit{startSymbol: starting non-terminal}}
  \item{\textit{rules}: set of grammar rules, which are objects of the class \textit{cRule}}
  \item{\textit{relation}: list representing a complementarity relation, it contains tuples of two terminals}
\end{itemize}

\section{Implementation of the grammars and input generators}
\section{Implementation of the test runner class and test scripts}
